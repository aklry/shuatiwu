...
export async function addQuestionBankQuestionUsingPost(
    ...
    return ryRequest.request<API.BaseResponseLong_>('/api/questionBankQuestion/add', {
        method: 'POST',
        headers: {
...
export async function getQuestionBankQuestionVoByIdUsingGet(
    ...
    return ryRequest.request<API.BaseResponseQuestionBankQuestionVO_>('/api/questionBankQuestion/get/vo', {
        method: 'GET',
        params: {
            ...params
        },
...
export async function listQuestionBankQuestionByPageUsingPost(
    ...
    return ryRequest.request<API.BaseResponsePageQuestionBankQuestion_>('/api/questionBankQuestion/list/page', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
export async function listQuestionBankQuestionVoByPageUsingPost(
    ...
    return ryRequest.request<API.BaseResponsePageQuestionBankQuestionVO_>('/api/questionBankQuestion/list/page/vo', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
export async function listMyQuestionBankQuestionVoByPageUsingPost(
    ...
    return ryRequest.request<API.BaseResponsePageQuestionBankQuestionVO_>('/api/questionBankQuestion/my/list/page/vo', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
export async function updateQuestionBankQuestionUsingPost(
    ...
    return ryRequest.request<API.BaseResponseBoolean_>('/api/questionBankQuestion/update', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
